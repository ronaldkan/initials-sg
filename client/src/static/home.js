                        ...
                        <div className="content">
                            ...
                            <div className="row has-text-centered">
                                <div className="col is-10 is-offset-1">
                                    ...
                                    <a className="sgds-button is-rounded is-medium" href="https://form.gov.sg/forms/govtech/5bd18e5c46209b000f56f3e0" target="_blank" without rel="noopener noreferrer">Let's Connect</a>
                                </div>
                            </div>
                        </div>
                    </div>
